...
open class Reminder(var textRemind: String, var dateRemind: String, var timeRemind: String,var reminderID: String, override var creationDate: String, override var creationTime: String):
    Creation {
