...
import com.example.koylinfasten.databinding.FragmentTodoNewBinding
 ...
 * Use the [TodoNewFragment.newInstance] factory method to
...
class TodoNewFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.button7.setOnClickListener {
            findNavController().navigate(R.id.action_todoNewFragment_to_fourthFragment)
        }
